                    ...
                    <div class="video-popup icon-center">
                        <div class="overlay-content">
                            <div class="thumbnail"><img class="radius-small"
                                    src="assets\images\server\Greylabelfx_Turkey flag 11_12_2024 .png"
                ...
                <div class="content">
                    <div class="inner">
                        ...
                        <h2 class="title">
                            ...
                            <p>GreyLabelFX offers FX Grey Label solutions in Turkey, allowing brokers to launch and
                                operate trading platforms without the need for a full FX Greylabel Server license. This
                                cost-effective solution provides access to FX Greylabel Server advanced features, such
                                as algorithmic trading, market depth, and detailed charting tools, under the broker’s
                                brand.
                            </p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700">
                <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                    ...
                    <div class="content">
                        ...
                        <p class="description b1 color-gray mb--0">Avoid expensive direct licenses, reducing initial
                            costs.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                ...
                <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                    ...
                    <div class="content">
                        ...
                        <p class="description b1 color-gray mb--0"> Personalize the platform with your brand and
                            features.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                ...
                <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                    ...
                    <div class="content">
                        ...
                        <p class="description b1 color-gray mb--0">Benefit from FX Greylabel Server multi-asset trading
                            and analysis tools.
...
<div class="container">
    ...
    <br>
    <p>Turkey's growing forex and CFD market makes it an ideal location for brokers to expand. GreyLabelFX offers
        seamless platform setup and support, helping brokers succeed in this competitive environment.
