...
<div class="termsCondition">
    <div class="container term-condition">
        <div class="row">
            <div class="col-lg-12">
                <div class="head-style">
                    <h1 class="text-center">Terms and Conditions</h1>
                    <h2>Welcome to GreyLabelFX!</h2>
                    <p>These terms and conditions outline the rules and regulations for the use of GreyLabelFX's Website, located at www.greylabelfx.com.</p>
                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use GreyLabelFX if you do not agree to take all of the terms and conditions stated on this page.</p>
                    <p>
                    ...
                    <h2>Cookies</h2>
                    <p>We employ the use of cookies. By accessing GreyLabelFX, you agreed to use cookies in agreement with the GreyLabelFX's Privacy Policy.</p>
                    <p>Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>
                    
                    <h2>License</h2>
                    <p>Unless otherwise stated, GreyLabelFX and/or its licensors own the intellectual property rights for all material on GreyLabelFX. All intellectual property rights are reserved. You may access this from GreyLabelFX for your own personal use subjected to restrictions set in these terms and conditions.</p>

                    <h3>You must not:</h3>
                    <ul>
                        <li>Republish material from GreyLabelFX</li>
                        <li>Sell, rent or sub-license material from GreyLabelFX</li>
                        <li>Reproduce, duplicate or copy material from GreyLabelFX</li>
                        <li>Redistribute content from GreyLabelFX</li>
                    </ul>
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. GreyLabelFX does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of GreyLabelFX,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, GreyLabelFX shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
                    <p>GreyLabelFX reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
                    ...
                    <p>You are entitled to post the Comments on our website and have all necessary licenses and consents to do so;
                        ...
                        You hereby grant GreyLabelFX a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
                    ...
                    <h2>We may consider and approve other link requests from the following types of organizations:</h2>
                    <ul>
                    ...
                    <ul>
                        ...
                        <li>The benefit to us from the visibility of the hyperlink compensates the absence of GreyLabelFX</li>
                        <li>The link is in the context of general resource information</li>
                    </ul>
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to GreyLabelFX. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>                    
                    ...
                    <ul>
                        ...
                        <li>No use of GreyLabelFX's logo or other artwork will be allowed for linking absent a trademark license agreement</li>
                    </ul>
                    ...
                    <hr>
                    <h2 class="text-center">Your Privacy</h2>
                    <h1 class="text-center"><a href="https://greylabelfx.com/privacy-policy.php"  style="color: #039AE4;">Please read Privacy Policy</a></h1>
...
@media (max-width: 768px) {
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K5VSCQZZ"
    ...
    <script type="application/ld+json">
    {
      ...
      "alternateName": "Term and Condition",
      "url": "https://greylabelfx.com/term-and-condition.php",
