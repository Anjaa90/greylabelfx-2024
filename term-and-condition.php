            ...
            <div class="row row--189">
                <div class="col-lg-12">
                    <div class="head-style">
                        ...
                        <h2 style="font-weight:bold; color: white; font-size:15px;">Welcome to GreyLabelFX!</h2>
                        <p>These terms and conditions outline the rules and regulations for the use of GreyLabelFX's
                            Website, located at www.greylabelfx.com.</p>
                        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to
                            use GreyLabelFX if you do not agree to take all of the terms and conditions stated on this
                            page.</p>
                        ...
                        <h2>Cookies</h2>
                        <p>
                            We employ the use of cookies. By accessing GreyLabelFX, you agreed to use cookies in
                            agreement with the GreyLabelFX's Privacy Policy.
                        ...
                        <p>Most interactive websites use cookies to let us retrieve the user’s details for each visit.
                            ...
                            use cookies.</p>
                        <h2>License</h2>
                        <p>Unless otherwise stated, GreyLabelFX and/or its licensors own the intellectual property
                            rights for all material on GreyLabelFX. All intellectual property rights are reserved. You
                            may access this from GreyLabelFX for your own personal use subjected to restrictions set in
                            these terms and conditions.</p>

                        <h3>You must not:</h3>
                        <p>
                            Republish material from GreyLabelFX<br>
                            Sell, rent or sub-license material from GreyLabelFX<br>
                            Reproduce, duplicate or copy material from GreyLabelFX<br>
                            Redistribute content from GreyLabelFX<br>
                            This Agreement shall begin on the date hereof. Our Terms and Conditions were created with
                            the help of the TermsFeed Free Terms and Conditions Generator.
                        </p>
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                            information in certain areas of the website. GreyLabelFX does not filter, edit, publish or
                            review Comments prior to their presence on the website. Comments do not reflect the views
                            and opinions of GreyLabelFX,its agents and/or affiliates. Comments reflect the views and
                            opinions of the person who post their views and opinions. To the extent permitted by
                            applicable laws, GreyLabelFX shall not be liable for the Comments or for any liability,
                            damages or expenses caused and/or suffered as a result of any use of and/or posting of
                            and/or appearance of the Comments on this website.
                        </p>
                        <p>
                            GreyLabelFX reserves the right to monitor all Comments and to remove any Comments which can
                        ...
                        <p>
                            ...
                            You hereby grant GreyLabelFX a non-exclusive license to use, reproduce, edit and authorize
                            others to use, reproduce and edit any of your Comments in any and all forms, formats or
                            media.
                        </p>
                        <h2>Hyperlinking to our Content</h2>
                        <h3>The following organizations may link to our Website without prior written approval:</h3><br>
                        <p>Government agencies;<br>
                            Search engines;<br>
                            News organizations;<br>
                            Online directory distributors may link to our Website in the same manner as they hyperlink
                            to the Websites of other listed businesses; and System wide Accredited Businesses except
                            soliciting non-profit organizations, charity shopping malls, and charity fundraising groups
                            which may not hyperlink to our Web site.<br>
                            These organizations may link to our home page, to publications or to other Website
                            information so long as the link:<br>
                            (a) is not in any way deceptive; <br>(b) does not falsely imply sponsorship, endorsement or
                            approval of the linking party and its products and/or services; <br> (c) fits within the
                            context of the linking party’s site.

                        </p>
                        <h3>We may consider and approve other link requests from the following types of organizations:
                        </h3>
                        <p>commonly-known consumer and/or business information sources;<br>
                            ...
                            We will approve link requests from these organizations if we decide that:<br> (a) the link
                            would not make us look unfavorably to ourselves or to our accredited businesses; <br>(b) the
                            organization does not have any negative records with us;<br> (c) the benefit to us from the
                            visibility of the hyperlink compensates the absence of GreyLabelFX;<br>(d) the link is in
                        ...
                        <p>By use of our corporate name; <br>
                            ...
                            No use of GreyLabelFX's logo or other artwork will be allowed for linking absent a trademark
                            license agreement.
                        </p>
                        <h2>iFrames</h2>
                        ...
                        <h4 style="    font-size: 27px;
                            font-weight: normal;
                        ">Removal of links from our website</h4>
                        ...
                        <h2 style="    font-size: 27px;
                            font-weight: normal;">Disclaimer</h2>
                        ...
                        <p>limit or exclude our or your liability for death or personal injury;<br>
                            ...
                            disclaimer:<br>(a) are subject to the preceding paragraph;<br> (b) govern all liabilities
