                    ...
                    <div class="video-popup icon-center">
                        <div class="overlay-content">
                            <div class="thumbnail"><img class="radius-small"
                                    src="assets\images\Greylabelfx _china Flag_11_12_2024 .png" alt="Corporate Image">
                            </div>
                ...
                <div class="content">
                    <div class="inner">
                        ...
                        <h2 class="title">
                            ...
                            <p>GreyLabelFX offers tailored FX Grey Label solutions in China, enabling brokers to launch
                                trading platforms with advanced features without the need for a full FX Greylabel Server
                                license. FX Greylabel Server is a global multi-asset platform supporting forex, stocks,
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700">
                <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                    ...
                    <div class="content">
                        ...
                        <p class="description b1 color-gray mb--0">Avoid high license costs while offering
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                ...
                <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                    ...
                    <div class="content">
                        ...
                        <p class="description b1 color-gray mb--0"> Personalize FX Greylabel Server to reflect your
                            brand identity.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                ...
                <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                    ...
                    <div class="content">
                        ...
                        <p class="description b1 color-gray mb--0">Access algorithmic trading, market depth, copy
                            trading, and more.
...
<div class="container">
    ...
    <br>
    <p>China's growing trading market offers significant opportunities. GreyLabelFX provides hassle-free setup,
