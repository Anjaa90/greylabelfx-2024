<?php include ('includes/header.php');?>
                            ...
                            <div class="video-popup icon-center">
                                <div class="overlay-content">
                                    <div class="thumbnail"><img class="radius-small"
                                            src="assets\images\server\Greylabelfx_Africa flag 11_12_2024 .png" alt="Corporate Image"></div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                            ...
                            <div class="content">
                                ...
                                <p class="description b1 color-gray mb--0"> Tailor the platform to your brand and local market preferences for a professional, personalized experience.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                            ...
                            <div class="content">
                                ...
                                <p class="description b1 color-gray mb--0">Offer features like multi-asset trading, algorithmic strategies, copy trading, and technical analysis.
        ...
        <div class="container">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                    ...
                    <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                        ...
                        <div class="content">
                            ...
                            <p class="description b1 color-gray mb--0"> Expand your platform into new markets and asset classes as your business grows.
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                    ...
                    <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                        ...
                        <div class="content">
                            ...
                            <p class="description b1 color-gray mb--0"> 24/7 technical support, server hosting, and ongoing maintenance.
            ...
            <br>
            <p>Africa's growing forex and CFD trading market, especially in Servers like Nigeria, South Africa, and Kenya, offers brokers significant opportunities. GreyLabelFX provides end-to-end solutions, helping brokers establish a strong presence in this dynamic market.
