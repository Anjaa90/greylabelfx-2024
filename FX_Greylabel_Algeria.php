                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700">
                        <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                            ...
                            <div class="content">
                                ...
                                <p class="description b1 color-gray mb--0"> Save on licensing costs and allocate resources efficiently.
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                            ...
                            <div class="content">
                                ...
                                <p class="description b1 color-gray mb--0"> Tailor the platform to match your brand and audience preferences.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                            ...
                            <div class="content">
                                ...
                                <p class="description b1 color-gray mb--0">Provide multi-asset trading, algorithmic strategies, and real-time analytics.
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                    ...
                    <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                        ...
                        <div class="content">
                            ...
                            <p class="description b1 color-gray mb--0"> Launch quickly and expand seamlessly as your business grows.
