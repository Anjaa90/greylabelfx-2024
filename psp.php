                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner pt--80 text-center" data-sal="slide-up" data-sal-duration="400"
                            ...
                            <h1 class="title display-one">PSP</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 mt_md--40 mt_sm--40">
                        <div class="content">
                            <div class="inner">
                                ...
                                <h2 class="title" style="font-size: 22px;">Dedicated Forex Payment Gateways (PSPs) For
                ...
                <div class="row row--40 align-items-center">
                            ...
                            <div class="inner">
                                ...
                                <div class="about-btn mt--30">
                                    For more Information <span> <a href="https://greylabelfx.com/contact.php"
                                            ...
                                            style="color: red;font-weight:bold">Telegram </a></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 mt_md--40 mt_sm--40">
                        <div class="video-btn">
                            <div class="video-popup icon-center">
                                <div class="overlay-content">
                                    <div class="thumbnail"><img class="radius-small" src="assets/images/about/psp2.png"
