                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner pt--80 text-center" data-sal="slide-up" data-sal-duration="400"
                            ...
                            <h1 class="title display-one" style="font-size: 70px;">Broker website </h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="video-popup icon-center">
                                <div class="overlay-content">
                                    <div class="thumbnail"><img 
                                            class="radius-small" src="assets/images/image.png" alt="Corporate Image">
                                    </div>
                ...
                <div class="row row--15 service-wrapper">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--2 text-center">
                            <div class="inner">
                                <div class="image">
                                    <img loading="lazy" src="assets/images/services/mobile-payment.png" alt="card Images">
                                </div>
                                <div class="content">
                                    <h3 class="title">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--2 text-center">
                            <div class="inner">
                                <div class="image">
                                    <img loading="lazy" src="assets/images/services/seo.png" alt="card Images">
                                </div>
                                <div class="content">
                                    <h3 class="title">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--2 text-center">
                            <div class="inner">
                                <div class="image">
                                    <img loading="lazy" src="assets/images/services/social-media.png" alt="card Images">
                                </div>
                                <div class="content">
                                    <h3 class="title">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--2 text-center">
                            <div class="inner">
                                <div class="image">
                                    <img loading="lazy" src="assets/images/services/strategy-development.png" alt="card Images">
                                </div>
                                <div class="content">
                                    <h3 class="title">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--2 text-center">
                            <div class="inner">
                                <div class="image">
                                    <img loading="lazy" src="assets/images/services/data-science.png" alt="card Images">
                                </div>
                                <div class="content">
                                    <h3 class="title">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--2 text-center">
                            <div class="inner">
                                <div class="image">
                                    <img loading="lazy" src="assets/images/services/cloud-hosting.png" alt="card Images">
                                </div>
                                <div class="content">
                                    <h3 class="title">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--2 text-center">
                            <div class="inner">
                                <div class="image">
                                    <img loading="lazy" src="assets/images/services/web-browser.png" alt="card Images">
                                </div>
                                <div class="content">
                                    <h3 class="title">
                                        <a href="#">FX Banners
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--2 text-center">
                            <div class="inner">
                                <div class="image">
                                    <img loading="lazy" src="assets/images/services/landing-page.png" alt="card Images">
                                </div>
                                <div class="content">
                                    <h3 class="title">
...
<script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "Broker Website",
      "alternateName": "Broker Website",
      "url": "https://greylabel-fx.com/broker-website.php",
