<?php include ('includes/header.php');?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="inner pt--80 text-center" data-sal="slide-up" data-sal-duration="400"
                            ...
                            <h1 class="title display-one">BrokerCRM</h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="video-popup icon-center">
                                <div class="overlay-content">
                                    <div class="thumbnail"><img class="radius-small"
                                            src="assets/images/about/contactimage-1.png" alt="Corporate Image"></div>
                    ...
                    <div class="col-lg-6 mt_md--40 mt_sm--40">
                        <div class="content">
                            <div class="inner">
                                ...
                                <h2 class="title">
                                    Build Stronger Relationships with GreylabelFX CRM
                                    </strong>
                                </h1>
                                <p>A CRM system is crucial for any Forex brokerage, and GreylabelFX Forex CRM is designed to help you stay connected and communicate effectively with your traders.
                                </p>
                                <p>Our Greylabel CRM improves your Forex brokerage by enhancing customer experience and satisfaction. Integrated with Trader's Room, it customizes to meet your specific business needs, streamlining complex processes with easy-to-use solutions.
                                </p>
                                <p>With GreylabelFX, you can build lasting relationships and optimize your brokerage's performance.
                                </p>

                                <div class="about-btn mt--30"><a class="btn-default" href="about.php">About Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row row--15 service-wrapper">
                    ...
                    <h2 class="heading-titile-normal text-center">
                        Benefits of Greylabel Forex CRM
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700">
                        <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                            ...
                            <div class="content">
                                <h3 class="title w-600">BROKER-CENTERED DESIGN
                                </h3>
                                <p class="description b1 color-gray mb--0">Every feature of our Forex CRM is tailored to meet the unique needs of Forex brokers.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                            ...
                            <div class="content">
                                <h3 class="title w-600">BUILT FOR PERFORMANCE
                                </h3>
                                <p class="description b1 color-gray mb--0">Enhance your brokerage's efficiency with tools for automation and marketing, all in one platform.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                        ...
                        <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                            ...
                            <div class="content">
                                <h3 class="title w-600">SMART DASHBOARDS
                                </h3>
                                <p class="description b1 color-gray mb--0">Access all the essential information you need with customizable dashboards designed for your convenience.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row row--15 service-wrapper">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700">
                    <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                        ...
                        <div class="content">
                            <h3 class="title w-600">EASY INTEGRATIONS
                            </h3>
                            <p class="description b1 color-gray mb--0">Seamlessly integrate with affiliate systems, emailers, SMS, and more to streamline your operations.
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                    ...
                    <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                        ...
                        <div class="content">
                            <h3 class="title w-600">PERFORMANCE TRACKING
                            </h3>
                            <p class="description b1 color-gray mb--0">Monitor sales and team performance both individually and collectively to track your success.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal="slide-up" data-sal-duration="700"
                    ...
                    <div class="service service__style--1 bg-color-blackest radius mt--25 text-center rbt-border-none"
                        ...
                        <div class="content">
                            <h3 class="title w-600" >CONTROL ACCESS
                            </h3>
                            <p class="description b1 color-gray mb--0">Set specific permissions for your team members to maintain maximum security and control over your data.
            ...
            <br>
            <p>With GreylabelFX Forex CRM, manage and grow your brokerage with ease and efficiency.
            </p>
        </div>
...
<script type="application/ld+json">
    {
      ...
      "url": "https://greylabel-fx.com/broker-crm.php",
